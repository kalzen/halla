                ...
                <div class="card profile-greeting p-0">
                  <div class="card-body">
                    <div class="img-overlay">
                      ...
                      <p>Welcome! We are delighted that you have visited our dashboard.</p><a class="btn" href="{{route('dashboard')}}">Go Premium</a>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <table class="table display" id="selling-product" style="width:100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard/project/2.png')}}" alt=""></div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard/project/3.png')}}" alt=""></div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard/project/4.png')}}" alt=""></div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                      ...
                      <table class="table display" style="width:100%">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard/product/1.png')}}" alt=""></div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard/product/2.png')}}" alt=""></div>
                                <div class="flex-grow-1"><a href="list-products.html">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard/product/3.png')}}" alt=""></div>
                                <div class="flex-grow-1"><a href="list-products.html">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard/product/4.png')}}" alt=""></div>
                                <div class="flex-grow-1"><a href="list-products.html">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="{{asset('assets/images/dashboard/product/5.png')}}" alt=""></div>
                                <div class="flex-grow-1"><a href="list-products.html">
